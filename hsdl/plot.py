...
def framebox(x1,x2,y1,y2,c=None,lw=None):
	...
	EXAMPLE I
	from aaspip.plot import framebox
	from aaspip.seistr import gensyn
	from matplotlib import pyplot as plt
	d=gensyn();
	plt.imshow(d);
...
def wiping(inpath, outpath, duration=500, number=30):
	...
	from aaspip import genplane3d,plot3d
	data,datan=genplane3d(noise=True,seed=202425,var=0.1);
	dn=datan[:,:,10]
	import aaspip.drr as pd
